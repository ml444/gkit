// protoc --proto_path=. --go_out=paths=source_relative:. -I=~/github.com/ml444/gctl-templates/protos ./errcode/errcode.proto
...
var file_errcode_errcode_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.EnumOptions)(nil),
		ExtensionType: (*int32)(nil),
		Field:         1500,
		Name:          "errcode.default_status",
		Tag:           "varint,1500,opt,name=default_status",
		Filename:      "errcode/errcode.proto",
	},
	{
		...
		Field:         1501,
		Name:          "errcode.detail",
		Tag:           "bytes,1501,opt,name=detail",
		Filename:      "errcode/errcode.proto",
	},
}
...
var (
	// optional int32 default_status = 1500;
	E_DefaultStatus = &file_errcode_errcode_proto_extTypes[0]
)

// Extension fields to descriptorpb.EnumValueOptions.
var (
	// optional errcode.ErrDetail detail = 1501;
	E_Detail = &file_errcode_errcode_proto_extTypes[1]
)
...
var file_errcode_errcode_proto_rawDesc = []byte{
	...
	0x0b, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x3a, 0x51, 0x0a, 0x06, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x21,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0xdd, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x65, 0x72, 0x72, 0x63, 0x6f,
	0x64, 0x65, 0x2e, 0x45, 0x72, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x06, 0x64, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x67, 0x6f, 0x2d, 0x65, 0x72, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x65, 0x72, 0x72, 0x63, 0x6f,
...
var file_errcode_errcode_proto_goTypes = []interface{}{
	(*ErrDetail)(nil),                     // 0: errcode.ErrDetail
...
var file_errcode_errcode_proto_depIdxs = []int32{
	1, // 0: errcode.default_status:extendee -> google.protobuf.EnumOptions
	2, // 1: errcode.detail:extendee -> google.protobuf.EnumValueOptions
	0, // 2: errcode.detail:type_name -> errcode.ErrDetail
...
func file_errcode_errcode_proto_init() {
	...
	file_errcode_errcode_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_errcode_errcode_proto_extTypes,
	}.Build()
