// Copied from kratos: https://github.com/go-kratos/kratos/internal/host/host.go
...
// ExtractEndpoint returns a private addr and port.
func ExtractEndpoint(hostPort string, lis net.Listener) (string, error) {
