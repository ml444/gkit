...
func NewAny(fn func(val interface{}) error) *anyHandler {
	return &anyHandler{fn: fn}
}
...
func (h *anyHandler) Apply(val interface{}) error {
	return h.fn(val)
}
...
// split2Int64 function: Based on the incoming string, parse out the start
...
// split2Uint64 function: Based on the incoming string, parse out the start
// and end values of the range.(like: between <begin> and <end>)
