...
func (x *ApiCommonResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
const file_response_proto_rawDesc = "" +
	"\n" +
	"\x0eresponse.proto\x12\bresponse\x1a\x19google/protobuf/any.proto\"\x8a\x01\n" +
	"\x11ApiCommonResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12(\n" +
	"\x04data\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x04data\x12\x1d\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestIdB\fZ\n" +
	"./responseb\x06proto3"
